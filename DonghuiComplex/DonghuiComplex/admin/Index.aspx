<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="DonghuiComplex.admin.Index" %>
<!DOCTYPE html>
<html lang="zh">
<head>
<meta charset="utf-8">
                    ...
                    <li class="active"><a href="javascript:;" data-toggle="slidebar"><i class="fa fa-check-square-o"></i> 功能管理 </a>
                        <div class="items hide" data-noinit="true">
                            <ul id="bjui-hnav-tree1" class="ztree ztree_main" data-toggle="ztree" data-on-click="MainMenuClick" data-expand-all="true" data-faicon="check-square-o">
                                ...
                                <li data-id="54" data-pid="5" data-url="dc/myteam.html"data-tabid="dc_myteam">楼盘</li>
                                <li data-id="55" data-pid="5" data-url="dc/message.html"data-tabid="dc_message" >留言</li>  
            ...
            <div class="tabsPageHeader">
                <div class="tabsPageHeaderContent">
                    <ul class="navtab-tab nav nav-tabs">                     
                        <li data-url="" data-tabid="" data-id="14"><a href="javascript:;"><span><i class="fa fa-home"></i> #maintab#</span></a></li>
                    </ul>
                </div>
