<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="DonghuiComplex.index" %>
		...
		<!-- Sidebar -->
			<section id="sidebar">
				<div class="inner">
					<nav>
						<ul>
							<li><a href="#intro">塞班岛生子</a></li>
							<li><a href="#one">移民</a></li>
			...
			<div id="wrapper">
				...
				<!-- Three -->
					<section id="three" class="wrapper style1 fade-up">
						<div class="inner">
							<h2>这里有丰富农副产品</h2>
							<p>这里没有转基因、没有污染，没有农药；完全绿色、健康产品</p>
							<div class="split style1">
								<section style="background-image:url('/images/sbd1.png')">
